---
name: aidevkit:flow:job-run-monitor
...
context: fork
agent: aidevkit:flow:job-run-monitor-agent
allowed-tools:
  - Bash
  - Read
  - Grep
...
NEXT STEPS
──────────
- Check data freshness        → /aidevkit:flow:data-freshness-monitor {catalog}.{schema}
- Analyze warehouse costs     → /aidevkit:flow:warehouse-cost-analyzer
- Review permissions          → /aidevkit:flow:permission-auditor {catalog}
════════════════════════════════════════════════════════════
```
