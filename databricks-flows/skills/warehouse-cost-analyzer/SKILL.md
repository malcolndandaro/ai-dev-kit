---
name: aidevkit:flow:warehouse-cost-analyzer
...
context: fork
agent: aidevkit:flow:warehouse-cost-analyzer-agent
allowed-tools:
  - Bash
  - Read
  - Grep
...
NEXT STEPS
──────────
- Monitor job health           → /aidevkit:flow:job-run-monitor
- Audit data freshness         → /aidevkit:flow:data-freshness-monitor {catalog}.{schema}
- Review access permissions    → /aidevkit:flow:permission-auditor {catalog}
════════════════════════════════════════════════════════════
```
