---
name: flow:null-completeness-auditor
...
context: fork
agent: flow:null-completeness-auditor-agent
allowed-tools:
  - Bash
  - Read
  - Grep
...
**If $ARGUMENTS is empty or missing catalog.schema, respond with:** "Usage: /flow:null-completeness-auditor <catalog.schema> [table1,table2,...]" and stop.
...
NEXT STEPS
──────────
- Optimize your tables        → /aidevkit:flow:table-analyzer {catalog}.{schema}
